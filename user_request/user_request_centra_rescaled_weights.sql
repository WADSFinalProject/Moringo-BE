...
DROP TABLE IF EXISTS `centra_rescaled_weights`;
...
--
-- Dumping data for table `centra_rescaled_weights`
--

LOCK TABLES `centra_rescaled_weights` WRITE;
/*!40000 ALTER TABLE `centra_rescaled_weights` DISABLE KEYS */;
/*!40000 ALTER TABLE `centra_rescaled_weights` ENABLE KEYS */;
UNLOCK TABLES;
